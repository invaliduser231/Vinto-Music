...
export function buildDeezerLegacyDownloadUrl(track, quality) {
  const md5Origin = String(track?.MD5_ORIGIN ?? '').trim();
...
export function parseContentRangeStart(value) {
...
export function isRetryableDeezerStreamError(err) {
