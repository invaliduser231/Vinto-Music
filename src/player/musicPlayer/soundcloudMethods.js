...
import { isSoundCloudAuthorizationError, soundCloudAuthorizationHelp } from './errorUtils.js';
import { isHttpUrl, normalizeThumbnailUrl, pickThumbnailUrlFromItem, toSoundCloudDurationLabel } from './trackUtils.js';

export const soundcloudMethods = {
